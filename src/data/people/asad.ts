...
export const asad: ProfileData = {
  ...
  engagements: [
    ...
    { title: "Outreach — Durbin & BDOAA", desc: "Durbin (astrophotography & science communication for the public) and the Bangladesh Olympiad on Astronomy & Astrophysics (BDOAA).", href: "/outreach/durbin" },
  ],
